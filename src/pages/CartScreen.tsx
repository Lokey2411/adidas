...
function CartScreen() {
  return (
    <div>
      ...
      <div className="flex w-full justify-around items-center border-solid border-2 border-black">
        ...
        <div className="w-1/2  ">
          ...
          <div className="flex flex-col">
            ...
            <input className="border w-1/5" type="number" />
          </div>
          <div>
            <button>Xóa</button>
          </div>
      ...
      <div>
        <button className="flex justify-center bg-white text-black hover:opacity-70 hover:bg-red-500 rounded-lg px-8 py-3 font-semibold mx-auto text-xl w-1/7 mb-4 cursor-pointer">
          Thanh toán
        </button>
      </div>
      <Contact/>
