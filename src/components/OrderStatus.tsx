...
const OrderStatus = () => {
	const statuses = ["Đặt hàng thành công", "Người bán đang chuẩn bị hàng", "Đơn vị vận chuyển lấy hàng thành công", "Đơn hàng đang trên đường giao đến bạn", "Đơn hàng được giao thành công"];
